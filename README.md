...
Authentication aka identifying who you are
- [ ] What steps can you take in your web apps to keep your data secure?
Implement protected routes using an authentication token and Redirect
- [ ] Describe how web servers work.
A computer connected to the internet that stores code for websites and serves them to others using special software.
